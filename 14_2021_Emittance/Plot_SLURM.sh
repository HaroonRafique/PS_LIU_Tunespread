...
RUN_DIR=/hpcscratch/user/harafiqu/PS_LIU_Tunespread/14_2021_Emittance
OrigIwd=$(pwd)
...
# Run the jobs
srun --exclusive -n 1 ./2021_00/Plot_Tune_and_Distn_Footprints.py &
srun --exclusive -n 1 ./2021_01/Plot_Tune_and_Distn_Footprints.py &
wait
